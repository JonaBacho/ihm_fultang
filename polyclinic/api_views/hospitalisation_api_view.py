...
from polyclinic.serializers import HospitalisationSerializer
...
@method_decorator(swagger_auto_schema(manual_parameters=[
    openapi.Parameter(name="Information sur les hospitalisation", in_=openapi.IN_QUERY, type=openapi.TYPE_STRING)
]), name="list")
class HospitalisationViewSet(ModelViewSet):
