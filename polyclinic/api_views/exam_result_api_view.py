...
from polyclinic.permissions.exam_result_permissions import ExamResultPermissions
from polyclinic.serializers.exam_result_serializers import ExamResultSerializer, ExamResultCreateSerializer
