    ...
    return (
        <div className="h-screen overflow-y-hidden flex justify-center p-4">
            <div className="max-w-4xl w-full text-center">
                ...
                <div className="flex flex-coltext-gray-600 w-2xl mb-8 text-md mx-auto">
                    {message && <p>{message}</p>}
                    <p>An internal error has occurred on our servers. Our technical team has been notified and is working to resolve the issue.</p>
                </div>
