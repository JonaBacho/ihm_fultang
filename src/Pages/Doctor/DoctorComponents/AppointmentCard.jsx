        ...
        <div className="bg-gray-100 rounded-lg shadow-md p-4  hover:shadow-lg transition-shadow">
            <div className="flex justify-between items-start mb-4">
                <div className="flex">
                    ...
                    <h3 className="text-xl font-semibold  mt-0.5 text-gray-800">{appointment?.patientName}</h3>
                ...
                <div className={`px-4 py-2 rounded-full text-sm font-semibold border-2  ${appointment.status === "upcoming" ? "bg-blue-100 text-blue-800 border-blue-500" : "bg-green-100 text-green-800 border-green-500"}`}>
                    {appointment?.status === "upcoming" ? "Future" : "Finished"}
                </div>
            </div>
            <div className="grid grid-cols-2 gap-4 ml-10">
                ...
                <div className="flex items-center text-gray-600">
                    ...
                    <span className="font-semibold">{appointment.phoneNumber}</span>
                </div>
                <div className="mt-1 flex flex-col">
                    <div className="flex ">
                        <ClipboardList className="h-6 w-6 mr-2 text-primary-end"/>
                        <h4 className="text-md font-medium text-gray-700 mb-2">Motif de la consultation</h4>
                    </div>
                    <p className="text-gray-600 font-semibold">{appointment.reason}</p>
                </div>
            </div>
